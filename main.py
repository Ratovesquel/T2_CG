...
def PosicUser():
    ...
    gluLookAt(0, 4, 10, 0, 2, 0, 0, 1.0, 0)
...
def teclado(key, x, y):
    o.rotation = (1, 1, 0, o.rotation[3] + 2)    
...
#Criação 1 ----------------------------------------------------- 
    ...
    glutCreateWindow(b'Computacao Grafica - T1')

    # Função responsável por fazer as inicializações
    init('Objetos\Bursto1.obj')
